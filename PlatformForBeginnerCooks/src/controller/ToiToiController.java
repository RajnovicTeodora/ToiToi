...
public class ToiToiController {
	...
	public void writteData() {
		/*
		 * // PRAVLJENJE OBJEKATA PA IH UPISEM PA TEK ONDA UCITAM, OVAKO ZA POCETAK PA
		 * CE // KASNIJE ICI DRUGACIJE Equipment e1 = new Equipment(1, "Serpa",
		 * "Metalac", "Duboka serpa, precnik 5cm"); Equipment e2 = new Equipment(2,
		 * "Tanjir", "Home", "Beli tanjir, precnik 10, keramika");
		 * 
		 * ArrayList<Equipment> equipmentList = new ArrayList<Equipment>();
		 * equipmentList.add(e1); equipmentList.add(e2);
		 * 
		 ...
		 * Product("Preliv od cokolade", "Nestle", 5); ArrayList<Product> ingredients =
		 * new ArrayList<Product>(); ingredients.add(p1); ingredients.add(p2);
		 * ingredients.add(p3); ingredients.add(p4); ingredients.add(p5);
		 * 
		 ...
		 * 
		 * Tag t1 = new Tag("Kineska kuhinja"); Tag t2 = new Tag("Vegan");
		 * ArrayList<Tag> tagList = new ArrayList<Tag>(); tagList.add(t1);
		 * tagList.add(t2);
		 * 
		 ...
		 * 
		 * Recipe recipe2 = new Recipe(); recipe2.setCreator(u1);
		 * recipe2.setRecipeID(2);
		 * recipe2.setDescription("Najlepsi milkshake koji cete ikada probati!");
		 * recipe2.setLikes(15); recipe2.setName("Milkshake"); recipe2.addComment(com);
		 * recipe2.addTags(t2); recipe2.addTastes(Taste.sweet);
		 * recipe2.addTastes(Taste.tangy); recipe2.addEquipment(e1);
		 * recipe2.setImage("./data/RecipeImage/milkshake.png");
		 * recipe2.setDateCreated(d2);
		 * 
		 * Recipe recipe3 = new Recipe(); recipe3.setCreator(u1);
		 * recipe3.setRecipeID(3);
		 * recipe3.setDescription("Najlepsi milkshake koji cete ikada probati!");
		 * recipe3.setLikes(1); recipe3.setName("Milkshake"); recipe3.addComment(com);
		 * recipe3.addTags(t2); recipe3.addTastes(Taste.sweet);
		 * recipe3.addTastes(Taste.tangy); recipe3.addEquipment(e1);
		 ...
		 * 
		 * recipeList.add(recipe2); recipeList.add(recipe3);
		 * 
		 * 
	...
	public User createUser(String name, String surname, String password, String username, String mail, String gender,
			String telephone, String address, LocalDate birthday) throws Exception {
